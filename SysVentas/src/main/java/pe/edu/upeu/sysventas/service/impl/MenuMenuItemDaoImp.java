...
public class MenuMenuItemDaoImp implements IMenuMenuItemDao {
    ...
    public List<MenuMenuItenTO> listaAccesos(String perfil, Properties idioma) {
        ...
        lista.add(new MenuMenuItenTO("miventa", "/view/main_venta.fxml", "Venta", "Reg. Venta", "Registrar Venta", "T"));
        lista.add(new MenuMenuItenTO("mireporte", "/view/main_reporte.fxml", "Venta", "Reportes", "Gestionar Reportes", "T"));

        lista.add(new MenuMenuItenTO("miusuario", "/view/main_usuario.fxml", idioma.getProperty("menu.nombre.usuario", "Usuario"), idioma.getProperty("menuitem.nombre.usuario", "Gestión Usuario"), "Gestión de Usuarios", "T"));
        lista.add(new MenuMenuItenTO("mistock", "/view/main_stock.fxml", "Inventario", "Gestión Stock", "Control de Stock", "T"));
        lista.add(new MenuMenuItenTO("micliente", "/view/main_cliente.fxml", "Cliente", "Reg. Cliente", "Gestionar Cliente", "T"));
